...
const ViewBonddata = () => {
  ...
  const [applicantNotVerifiedRemarks, setApplicantNotVerifiedRemarks] =
    useState("");
  const [nomineeNotVerifiedRemarks, setNomineeNotVerifiedRemarks] =
    useState("");
  ...
  const [nomineeUploadPassportImgView, setNomineeUploadPassportImgView] =
    useState(false);
  ...
  const [secondApplicantPassportView, setSecondApplicantPassportView] =
    useState(false);
  ...
  const ViewDocuments = () => {
    ...
    PostApi(method, url, data, headers)
      .then((response) => {
        ...
        // const decImg = base64ToImageUrl(response.data.data.declarationSignImg);
        // setdecImgImgPreview(decImg);
        ...
        if (
          response.data.data.applicantVerified === true &&
          response.data.data.nomineeVerified === true
        ) {
  ...
  const ApproveBond = (event) => {
    ...
    if (
      ...
      applicantNotVerified === false &&
      nomineeStatus === false &&
      nomineeNotVerified === false
    ) {
      setShowErrorAlert(true);
      setAlertErrorMessage(
        "Please ensure to verify the details of the Application or nominee before giving your approval"
      );
      return;
    }
    if (
    ...
    if (
      applicantNotVerified === true &&
      applicantNotVerifiedRemarks.trim().length === 0
    ) {
      setShowErrorAlert(true);
      setAlertErrorMessage(
        "Please enter the remarks that explain the reason for rejecting the application."
      );
      return;
    }
    if (
      nomineeNotVerified === true &&
      nomineeNotVerifiedRemarks.trim().length === 0
    ) {
      setShowErrorAlert(true);
      setAlertErrorMessage(
        "Please enter the remarks that explain the reason for rejecting the nominee."
      );
      return;
    }
  ...
  const ApproveByApprover = () => {
    var applicationStatus;
    var nomineStatus;

    if (applicantStatus === true && applicantNotVerified === false) {
      applicationStatus = true;
    } else if (applicantStatus === false && applicantNotVerified === true) {
      applicationStatus = false;
    }

    if (nomineeStatus === true && nomineeNotVerified === false) {
      nomineStatus = true;
    } else if (nomineeStatus === false && nomineeNotVerified === true) {
      nomineStatus = false;
    }
    ...
    if (applicantStatus === false) {
      url +=
        "&applicantRemarks=" + encodeURIComponent(applicantNotVerifiedRemarks);
    }

    if (nomineeStatus === false) {
      url += "&nomineeRemarks=" + encodeURIComponent(nomineeNotVerifiedRemarks);
    }

    PostApi(method, url, data, headers)
      .then((response) => {
        if (response.data.message === "Form Verified.") {
          setAlertTitle("Success")
          setAlertType("success")
          setShowAlert(true);
          setShowYesorNoAlert(false);
          setAlertMessage("Application Verified and ready for Allotment.");
        } else {
          setAlertTitle("")
          setAlertType("error")
          setShowYesorNoAlert(false);
              ...
              <div className="gpbond_card">
                ...
                <div>
                  ...
                  <text className="gpbond_hed">
                    Regd Office: Ananda Nilayam,No.31/10, Arya Gowda Road, West
                    ...
                    {clientscheme === 2 ? (
                      <div>
                        ...
                        >
                          ...
                          REDEEMABLE PREFERENCE SHARES WITHOUT COUPON RATE
                        </p>
                      </div>
                    ) : clientscheme === 1 ? (
                      <div>
                        ...
                        >
                          APPLICATION FOR RESIDENTS TO APPLY FOR CUMULATIVE
                          REDEEMABLE PREFERENCE SHARES WITH COUPON RATE AT 9%
                          PER ANNUM.
                        </p>
                      </div>
                    ) : clientscheme === 3 ? (
                      <div>
                        <p
                          ...
                          style={{ textAlign: "center" }}
                        >
                          APPLICATION FOR NON-RESIDENTS TO APPLY FOR
                          COMPULSORILY CONVERTIBLE PREFERENCE SHARES WITH A
                          COUPON RATE AT 9% PER ANNUM.
                        </p>
                      </div>
                    ) : null}
                  </div>
                  {/* <text className="gpbond_text" style={{ textAlign: 'center' }}>APPLICATION FOR RESIDENTS TO APPLY FOR CUMULATIVE REDEEMABLE PREFERENCE SHARES WITHOUT A COUPON</text> */}
                  <br></br> <br></br>
                  <div className="row">
                    <div className="col-lg">
                      <div className="collg-12">
                        ...
                        <span className="bond_label">
                          ...
                          Golden Planet Senior Heritage Homes Private Limited{" "}
                          <br></br>Regd. Off: Ananda Nilayam, 31/10, Arya Gowda
                          Road <br></br> West Mambalam, Chennai - 600033
                          <br></br>-------------------------------------
                        </span>
                      </div>
                    </div>
                                        ...
                                        {nomineeUploadPanImgPreview &&
                                          ...
                                          nomineeUploadPanImgPreview.endsWith(
                                            ...
                                            <img
                                              alt=""
                                              onClick={() =>
                                                setNomineeUploadPanImgView(true)
                                              }
                                      ...
                                      <div className="responsive-column">
                                        ...
                                        {selectedNationality === "INDIAN" ? (
                                          ...
                                          <input
                                            ...
                                            onChange={(e) =>
                                              setNomineePassport(e.target.value)
                                            }
                                          />
                                        )}
                                      </div>
                                            ...
                                            {nomineeUploadPassPortImgPreview &&
                                              ...
                                              nomineeUploadPassPortImgPreview.endsWith(
                                                ...
                                                <img
                                                  alt=""
                                                  onClick={() =>
                                                    setNomineeUploadPassPortImgView(
                                                      true
                                                    )
                                                  }
                                                  src={
                                ...
                                {selectedsecondApplicantNationality !==
                                  ...
                                  <div className="col-lg-4 col-12">
                                    <div className="responsive-column">
                                      <label className="bond_label">
                                        {" "}
                                        NATIONALITY OF SECOND APPLICANT :
                                      </label>
                                      <input
                                        type="text"
                                        className="inputbond"
                                    ...
                                    <div className="responsive-column">
                                        ...
                                        secondnomineeUploadPanImgPreview.endsWith(
                                          ...
                                          <div className="preview_card_img">
                                            <img
                                              alt=""
                                              onClick={() =>
                                                setSecondApplicantPanView(true)
                                              }
                                              src={
                                                secondnomineeUploadPanImgPreview
                                              }
                                      ...
                                      {secondApplicantPanView && (
                                        <Lightbox
                                          ...
                                          onCloseRequest={() =>
                                            setSecondApplicantPanView(false)
                                          }
                                          onImageLoad={() => {
                                            window.dispatchEvent(
                                              new Event("resize")
                                            ...
                                            secondnomineeUploadPassPortImgPreview.endsWith(
                                              ...
                                              <div className="preview_card_img">
                                                <img
                                                  alt=""
                                                  onClick={() =>
                                                    setSecondApplicantPassportView(
                                                      true
                                                    )
                                                  }
                                                  src={
                                ...
                                {selectedthirdApplicantNationality !== null && (
                                  <div className="col-lg-4 col-12">
                                    <div className="responsive-column">
                                      <label className="bond_label">
                                        {" "}
                                        NATIONALITY OF THIRD APPLICANT :
                                      </label>
                                      <input
                                        type="text"
                                        className="inputbond"
                                        ...
                                        <div className='col-lg-4 col-12'>
                                            <div className='responsive-column'>
                                                ...
                                                <input
                                                    ...
                                                    className='inputbond'
                                                    readOnly
                                                    value={accountInfoDate}
                                                />
                                            </div>
                                        </div>
                                        <div className='col-lg-4 col-12'>
                                            <div className='responsive-column'>
                                                <label className='bond_label'>UTR NUMBER / CHEQUE NUMBER : </label>
                                                <input
                                                    id="utr"
                                                    type="text"
                        ...
                        {applicantNotVerified === false && (
                          <div className="login_label payment_checkbox_div">
                            <input
                              ...
                              id="applicantstatus"
                              onChange={(e) =>
                                setApplicantStatus(e.target.checked)
                              }
                              checked={applicantStatus}
                            />
                            <label className="payment_label_approver">
                              The above details of the Applicant is verified.{" "}
                        ...
                        {applicantStatus === false && (
                          <div className="login_label payment_checkbox_div">
                            <input
                              ...
                              id="applicantstatus"
                              onChange={(e) =>
                                setApplicantNotVerified(e.target.checked)
                              }
                              checked={applicantNotVerified}
                              disabled={rejectedFlag}
                            />
                            <label className="payment_label_approver">
                              {" "}
                              The above details of the Applicant is not
                        ...
                        {applicantNotVerified === true && (
                          <div className="input_contanier">
                            <textarea
                              ...
                              value={applicantNotVerifiedRemarks}
                              onChange={(e) =>
                                setApplicantNotVerifiedRemarks(e.target.value)
                              }
                              maxLength={100}
                            />
                          </div>
                        ...
                        {nomineeNotVerified === false && (
                          <div className="login_label payment_checkbox_div">
                            <input
                              ...
                              id="agreeCheckbox"
                              onChange={(e) =>
                                setNomineeStatus(e.target.checked)
                              }
                              checked={nomineeStatus}
                            />
                            <label className="payment_label_approver">
                              The above details of the Nominee is verified.{" "}
                              <span style={{ color: "red" }}>*</span>
                            </label>
                          </div>
                        )}
                        {nomineeStatus === false && (
                          <div className="login_label payment_checkbox_div">
                            <input
                              ...
                              id="agreeCheckbox"
                              onChange={(e) =>
                                setNomineeNotVerified(e.target.checked)
                              }
                              checked={nomineeNotVerified}
                              disabled={rejectedFlag}
                            />
                            <label className="payment_label_approver">
                              {" "}
                              The above details of the Nominee is not verified.
                              <span style={{ color: "red" }}>*</span>
                            </label>
                          </div>
                        )}
                        {nomineeNotVerified === true && (
                          <div className="input_contanier">
                            <textarea
                              ...
                              rows={3}
                              placeholder="Enter the Remarks"
                              value={nomineeNotVerifiedRemarks}
                              onChange={(e) =>
                                setNomineeNotVerifiedRemarks(e.target.value)
                              }
                              maxLength={100}
                            />
                          </div>
                      ...
                      <div>
                        {remarkList.length !== 0 && (
                          <div>
                            ...
                            >
                              Remarks History of the Investment
                            </span>
                          </div>
                        )}
                      </div>
                ...
                <div className="gpbond_card col-lg-12">
                  {/* <div className='row'>
                                    ...
                                    <div className="row" style={{ marginTop: "2%" }}>
                                        <div className='col-lg-4 col-12'>
                                            <div className='responsive-column'>
                                                <label className='bond_label'>COUNTRY OF REMITTANCE : </label>
                                                <input
                                                    id="countryofremittance"
                                                    type="text"
                                                    readOnly
                                                    placeholder="country of remittance"
                                                    className='inputbond'
                                        ...
                                        <div className='col-lg-4 col-12'>
                                            <div className='responsive-column'>
                                                <label className='bond_label'>CURRENCY OF REMITTANCE : </label>
                                                <input
                                                    id="currencyofremittance"
                                                    type="text"
                                                    readOnly
                                                    disabled
                                                    placeholder="currency of remittance"
                                                    className='inputbond'
                                        ...
                                        <div className='col-lg-4 col-12'>
                                            <div className='responsive-column'>
                                                <label className='bond_label'>AMOUNT IN CURRENCY :  <span className="required">*</span> </label>
                                                <input
                                                    id="utr"
                                                    type="tel"
                                                    value={amount}
                                        ...
                                        {selectedCurrency === "USD" && (
                                            <>
                                                <div className='col-lg-4 col-12'>
                                                    <div className='responsive-column'>
                                                        <label className='bond_label'>SWIFT NUMBER : </label>
                                                        <input
                                                            id="swiftNumber"
                                                            type="tel"
                                                ...
                                                <div className='col-lg-4 col-12'>
                                                    <div className='responsive-column'>
                                                        <label className='bond_label'>SWIFT CODE OF REMITTING BANK : </label>
                                                        <input
                                                            id="utr"
                                                            type="tel"
                                                            disabled
                                                            placeholder="Swift Of Remittance Bank"
                                                            className='inputbond'
                                                            value={modeofPayment}
                                                            onChange={(e) => {
                                                ...
                                                <div className='col-lg-4 col-12'>
                                                    <div className='responsive-column'>
                                                        <label className='bond_label'>UPLOAD SWIFT ADVICE : </label>
                                                        <input
                                                            id="chequeUploadImg"
                                                        ...
                                                        {swiftadviceImgPreview && (
                                                            <div className="preview_card_img">
                                                                <img src={swiftadviceImgPreview} onClick={() => setChequeUploadView(true)} alt="Selected" className='bondimgPreview' />
                                                            </div>
                                                        )}
                                                        {swiftUploadImageview && (
                                                            <Lightbox
                                                                mainSrc={swiftadviceImgPreview}
                                                                onCloseRequest={() => setSwiftUploadImageview(false)}
                                                                onImageLoad={() => {
                                                                    window.dispatchEvent(new Event('resize'));
                                                                }}
                                                            />
                  ...
                  <div>
                    ...
                    {selectedCurrency === "USD" && (
                      <div className="row" style={{ marginTop: "2%" }}>
                        ...
                        {/* <div className='col-lg-4 col-12'>
                                                    <div className='responsive-column'>
                                                        <label className='bond_label'>DECLARATION IMAGE : </label>
                                                        {decImgPreview && (
                                                            <div>
                                                                <img src={decImgPreview} onClick={() => setdecImgView(true)} alt="Selected" className='bondimgPreview' />
                                                            </div>
                                                        )}
                                                        {decImgView && (
                                                            <Lightbox
                                                                mainSrc={decImgPreview}
                                                                onCloseRequest={() => setdecImgView(false)}
                                                                onImageLoad={() => {
                                                                    window.dispatchEvent(new Event('resize'));
                                                                }}
                                                            />
