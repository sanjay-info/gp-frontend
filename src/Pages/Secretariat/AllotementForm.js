                                    ...
                                    <div className='col-lg-4 col-12'>
                                        <div className='responsive-column'>
                                            ...
                                            <DatePicker
                                                ...
                                                disabled={allocationApproveFlag || allocationVerified === false}
                                    ...
                                    <div className='col-lg-4 col-12'>
                                        <div className='responsive-column'>
                                            ...
                                            <input
                                                ...
                                                className='inputbond'
                                                id='allottmentDate'
                                                readOnly={allocationApproveFlag === true || allocationReject === true || allocationVerified === false}
                                    ...
                                    <div className='col-lg-4 col-md-4'>
                                        <div className='responsive-column'>
                                            ...
                                            <input
                                                ...
                                                className="inputbond"
                                                disabled={allocationReject === true || certificateFlag === false}
                                            />
                                            ...
                                            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "20px" }}>
                                                <div className='row' style={{ paddingTop: "10px", display: "flex", alignItems: "center" }}>
                                                    <div className='login_label' >
                                                        <input type="radio" disabled={allocationApproveFlag === true || allocationReject === true} id="applicantstatus" onChange={(e) => { setAllocationVerified(true); setAllocationRemarks('');setRejectionnDate('') }} checked={allocationVerified === true} />
                                                        <label style={{ paddingLeft: "5px" }}>Approve.</label>
                                                    </div>
                                                </div>
                                                <div className='row' style={{ paddingTop: "10px" }}>
                                                    <div className='login_label' >
                                                        <input type="radio" disabled={allocationApproveFlag === true || allocationReject === true} id="applicantstatus" onChange={(e) => {
                                                            setAllocationDate(null)
                                                            setNoOfAllocationUnits("")
                                                            setAllocationVerified(false)
                                                        }} checked={allocationVerified === false} />
